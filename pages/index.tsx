    ...
    <Layout>
      <ul className="ml-[1.25rem] mt-[1.5rem] break-words md:ml-[1.25rem] md:mt-[1.5rem]">
        {newsFetched.map((news, newsCounted) => {
          const { title, commentCount, by, votes, createdAt } = news;

          return (
            <li className="md:ml-4 cursor-pointer pb-2 pr-4" key={votes}>
              <h1
              ...
              <p className="text-gray-500 ml-[1rem] text-[0.8rem] md:text-[0.75rem]">
